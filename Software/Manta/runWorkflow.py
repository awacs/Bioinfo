#!/usr/bin/env python
# Workflow run script auto-generated by command: '/apps/lab/miket/manta/0.29.5/bin/configManta.py --bam /PHShome/hw878/Rawdata/practice_bams/14415.fa.bam --referenceFasta /PHShome/hw878/Rawdata/manta_practice.fa --runDir ./'
#

import os, sys

scriptDir=os.path.abspath(os.path.dirname(__file__))
sys.path.append(r'/apps/lab/miket/manta/0.29.5/lib/python')
...
main(r"/PHShome/hw878/Software/Manta/runWorkflow.py.config.pickle","manta",MantaWorkflow)
